...
int main(int argc, char** argv){
    ...
    auto do_layer=[&](int l){
        ...
        blackwell::kernels::gemv_int8_warp(d_Q,d_xi,d_xs,L[l].q.d,L[l].q.sc,H,Q,0);
        blackwell::kernels::gemv_int8_warp(d_K,d_xi,d_xs,L[l].k.d,L[l].k.sc,H,KV,0);
        blackwell::kernels::gemv_int8_warp(d_V,d_xi,d_xs,L[l].v.d,L[l].v.sc,H,KV,0);
        ...
        blackwell::kernels::gemv_int8_warp(d_proj,d_ai,d_as,L[l].o.d,L[l].o.sc,Q,H,0);
        ...
        blackwell::kernels::gemv_int8_warp(d_gate,d_xi,d_xs,L[l].g.d,L[l].g.sc,H,I,0);
        blackwell::kernels::gemv_int8_warp(d_up,d_xi,d_xs,L[l].u.d,L[l].u.sc,H,I,0);
        blackwell::kernels::apply_swiglu(d_mlp,d_gate,d_up,I,0);
        blackwell::kernels::pack_int8(d_mi,d_mlp,d_ms_out,I,0);
        blackwell::kernels::gemv_int8_warp(d_proj,d_mi,d_ms_out,L[l].d.d,L[l].d.sc,I,H,0);
    ...
    T.start(); blackwell::kernels::gemv_int8_warp(d_Q,d_xi,d_xs,L[0].q.d,L[0].q.sc,H,Q,0);
    kt[NK].n="Q"; kt[NK++].us=T.stop()*1e6;
    T.start(); blackwell::kernels::gemv_int8_warp(d_K,d_xi,d_xs,L[0].k.d,L[0].k.sc,H,KV,0);
    kt[NK].n="K"; kt[NK++].us=T.stop()*1e6;
    T.start(); blackwell::kernels::gemv_int8_warp(d_V,d_xi,d_xs,L[0].v.d,L[0].v.sc,H,KV,0);
    ...
    T.start(); blackwell::kernels::gemv_int8_warp(d_proj,d_ai,d_as,L[0].o.d,L[0].o.sc,Q,H,0);
    ...
    T.start(); blackwell::kernels::gemv_int8_warp(d_gate,d_xi,d_xs,L[0].g.d,L[0].g.sc,H,I,0);
    kt[NK].n="gate"; kt[NK++].us=T.stop()*1e6;
    T.start(); blackwell::kernels::gemv_int8_warp(d_up,d_xi,d_xs,L[0].u.d,L[0].u.sc,H,I,0);
    ...
    T.start(); blackwell::kernels::gemv_int8_warp(d_proj,d_mi,d_ms_out,L[0].d.d,L[0].d.sc,I,H,0);
